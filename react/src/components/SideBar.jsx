    ...
    return (
        <aside className="backdrop-blur-md rounded-lg shadow-md w-full h-screen grid grid-rows-[auto_1fr_auto] p-4">
            ...
            <ul className="text-xl text-center space-y-7 font-[cinzel]">
                <p onClick={() => setFirstComponent("guilda")}
                    className="hover:text-gray-300 hover:drop-shadow-[0_0_8px_#D1D5DB] hover:cursor-pointer">
                    Guilda
                </p>
                <p onClick={() => setFirstComponent("missoes")}
                    className="hover:text-gray-300 hover:drop-shadow-[0_0_8px_#D1D5DB] hover:cursor-pointer">
                    Missões
                </p>
                <p onClick={() => setFirstComponent("profile")}
                    className="hover:text-gray-300 hover:drop-shadow-[0_0_8px_#D1D5DB] hover:cursor-pointer">
                    Profile
                </p>
            </ul>
